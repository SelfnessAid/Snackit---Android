...
/**
 * Created by Schmänd on 26.09.2016.
 */
    ...
    public void loadDataWithBaseURL(String baseUrl, String data, String mimeType, String encoding, String historyUrl) {
        ...
        super.loadDataWithBaseURL(baseUrl, "<style>"
            ...
            /*Setting the style attribute to fit the image in the screen*/
                ...
                "<script src=\"http://spire.de/snackit/360/jquery.min.js\"></script>\n" +
                "    <script type=\"text/javascript\" src=\"http://spire.de/snackit/360/j360.js\"></script>\n" +
                "</head>\n" +
